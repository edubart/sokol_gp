...
static void _sgp_setup_pipelines() {
    ...
    ngp.textriangles_pip = sg_make_pipeline(&(sg_pipeline_desc){
        ...
        .layout.attrs[1] = { .offset=offsetof(sgp_texvertex, texcoord), .format=SG_VERTEXFORMAT_USHORT2N },
    });
